      ...
      <header className="h-20 bg-brand-background flex items-center justify-between px-10 shrink-0">
        ...
        <div className="flex items-center gap-6 ml-4">
          ...
          <button 
            ...
            className="bg-brand-primary hover:bg-brand-primary-hover text-white flex items-center gap-1.5 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all"
          >
